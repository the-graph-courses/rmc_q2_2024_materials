...
Use `pacman::p_load()` to load the following packages: `{tidyverse}`, `{here}` and `{janitor}`.
...
-   Change the capitalization of the gender column to title case using `mutate()` and `str_to_title()`.
